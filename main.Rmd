...
## Exploration of Novel Covariates
...
## Why Not Use More Common Techniques to Pool Information
...
Each pharmacokinetic parameter has an associated set of regression coefficients and intercept term.  Subject covariates $\mathbf{x}_{j, s}$ will effect the clearance rate, time to max concentration, alpha, and bioavailability like
