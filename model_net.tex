...
\begin{figure}[t!]
   ...
   \edge{mu}{u_F};
	...
	\plate[color=blue]{experimental}{(rommel_model)(r_sigma)}{\color{blue}{Experimental Model}};
	\plate[color=red]{observational}{(u_Cl)(u_t)(u_a)(u_F)(u_C)(u_time)(u_y)(u_sigma)}{\color{red}{Observational Model}};
	\end{tikzpicture}
