...
generated quantities{
  ...
  vector[24] ccheck = concentration(tcheck, rep_vector(2.5, 119), rep_vector(inv_logit(mu_F), 119), rep_vector(mu_V, 119), rep_vector(exp(mu_ke)/a, 119), rep_vector(exp(mu_ke), 119));
}
