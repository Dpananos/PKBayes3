...
transformed parameters{
 ...
 for(i in 0:10){
   C = C + concentration(rep_vector(12.0*i, n), dose_mg_twice_daily, F, rep_vector(V, n), ka, ke);
 }
 C = C + concentration(hrs_post_dose, dose_mg_twice_daily, F, rep_vector(V, n), ka, ke);
}
model{
  V ~ normal(21.0, 1.0);
