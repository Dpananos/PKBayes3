...
generated quantities{
  ...
  vector[n] test_V = mu_V*exp(b_sex_V*test_sex);
  vector<lower=0>[n] test_ke = mu_ke*exp(b_creatinine_ke*scaled_test_creatinine + b_weight_ke*scaled_test_weight + b_age_ke*scaled_test_age + b_sex_ke*test_sex);
